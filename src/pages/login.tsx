...
function getRedirectTarget(location: string) {
...
export default function Login() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    toast({
      ...
      description: t("auth.login.toastDescription"),
    });
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[var(--xd-bg)] px-4 py-10 sm:px-6 lg:py-16">
      ...
      <div className="relative z-10 mx-auto flex min-h-[560px] min-w-0 w-[calc(100vw-2rem)] max-w-[1040px] overflow-hidden rounded-[28px] border border-[var(--xd-gold-border-soft)] bg-white/78 shadow-[0_32px_80px_rgba(58,38,0,0.12)] backdrop-blur-xl">
        <div className="relative hidden w-[42%] shrink-0 overflow-hidden p-2 md:block">
          <div className="relative isolate flex h-full min-h-[544px] flex-col overflow-hidden rounded-[22px] bg-[#241900] px-8 py-8 text-white">
          ...
          <div className="min-w-0 w-full max-w-[440px]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                ...
                className="h-[52px] w-full gap-2 text-[15px]"
            ...
            <p className="mt-6 text-center text-[13px] text-[#717182]">
              ...
              <Link href="/signup" className="font-bold text-[var(--xd-gold-text)] transition hover:text-[#050505]">
